// Code generated by the Encore v1.27.0 client generator. DO NOT EDIT.
...
export function Environment(name: string): BaseURL {
  return `https://${name}-captions-fgri.encr.app`;
}
...
/**
 * Client is an API client for the captions-fgri Encore application.
 */
...
class BaseClient {
  ...
  constructor(baseURL: string, options: ClientOptions) {
    ...
    this.headers = {
      ...
      "User-Agent": "captions-fgri-Generated-TS-Client (Encore/v1.27.0)",
    };
